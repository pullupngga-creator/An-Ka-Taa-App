...
import 'package:an_ka_taa_app/components/livraison/etape1_compagnie_main.dart';
import 'package:an_ka_taa_app/services/livraison_service.dart';
import 'package:an_ka_taa_app/style.dart';
import 'package:flutter/material.dart';

class Etape1Compagnie extends StatelessWidget {
  const Etape1Compagnie({super.key});
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: GestureDetector(
          onTap: () {
            final selectedCompany = LivraisonService().selectedCompany;
